...
?>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Family Clock 40x30</h6>
        </div>
        <!-- Filter Option-->
    ...
    <div class="page-content-wrapper">
      ...
      <div class="product-slides owl-carousel">
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/3.jpg" alt=""></div>
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/8.jpg" alt=""></div>
        <!-- Single Hero Slide-->
      </div>
      <div class="product-description pb-3">
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container d-flex justify-content-between">
            <div class="p-title-price">
              <h6 class="mb-1">Family Clock 40x30</h6>
              <p class="sale-price mb-0">Rp. 167.200<span>Rp. 240.000</span></p>
            </div>
          </div>
          <!-- Ratings-->
        ...
        <div class="p-specification bg-white mb-3 py-3">
          <div class="container">
            <h6>Spesifikasi</h6>
            <p>Jam Dinding Costum Didesain khusus untuk kado pernikahan,keluarga, aniversary, dan lain-lain. Jam Costum ini akan menjadi hadiah yang spesial karena kamu bisa request nama pasangan dan tanggal pernikahannya sehingga temanmu akan selalu ingat.</p>
            <ul>
              <li>👉🏼 ukuran diameter 40x30 cm</li>
    ...
    <div class="footer-nav-area" id="footerNav">
      <div class="suha-footer-nav h-100 py-1">
          <ul>
            <center>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Family%20Clock%2040x30"><button class="btn btn-success btn-lg" ><i class="lni-whatsapp"></i>&nbsp;Whatsapp</button>&nbsp;&nbsp;</a>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Family%20Clock%2040x30"><button class="btn btn-danger btn-lg w-50">Pesan sekarang</button></a>
            </center>
          </ul> 
      </div> 
    </div>
