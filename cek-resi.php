    ...
    <div class="page-content-wrapper">
      <div class="container">
        ...
        <div class="checkout-wrapper-area py-3">
          <div class="credit-card-info-wrapper"><img class="d-block mb-4" src="img/bg-img/14.png" alt="">
            <center><h4>Halaman sedang perbaikan.</h4></center>
          </div>
        </div>
      </div>
    </div>
