...
?>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Acrylic Music Box Otomatis</h6>
        </div>
        <!-- Filter Option-->
    ...
    <div class="page-content-wrapper">
      ...
      <div class="product-slides owl-carousel">
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/5.jpg" alt=""></div>
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/14.jpg" alt=""></div>
        <!-- Single Hero Slide-->
      </div>
      <div class="product-description pb-3">
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container d-flex justify-content-between">
            <div class="p-title-price">
              <h6 class="mb-1">Acrylic Music Box Otomatis</h6>
              <p class="sale-price mb-0">Rp. 248.900<span>Rp. 288.000</span></p>
            </div>
          </div>
          <!-- Ratings-->
        ...
        <div class="selection-panel bg-white mb-3 py-3">
          <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="choose-size-wrapper">
              <p class="mb-0">Pilihan Lagu</p>
              <p></p>
              <ul>
                <button class="btn btn-light">Happy Birthday</button>
                <button class="btn btn-light">I Just Call You</button>
                <p></p>
                <button class="btn btn-light">Somewhere Rainbow</button>
                <button class="btn btn-light">Cant Help Falling in Love</button>
                <p></p>
                <button class="btn btn-light">Castle in The Sky</button>
                <button class="btn btn-light">Your are The Shunsine</button>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="p-specification bg-white mb-3 py-3">
          <div class="container">
            <h6>Spesifikasi</h6>
            <p>PERTAMA DI INDONESIA Acrylic MUSIC BOX OTOMATIS</p>
            <ul>
              <li>Custom Tulisan & Foto</li>
              <li>Size : 9cm x 6cm x 5cm</li>
              <li>Material : Acrylic Premium</li>
              <li>Furnish : Mewah & Modern</li>
            </ul>
          </div>
        </div>
    ...
    <div class="footer-nav-area" id="footerNav">
      <div class="suha-footer-nav h-100 py-1">
          <ul>
            <center>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Acrylic%20Music%20Box"><button class="btn btn-outline-success btn-lg w-30 " ><i class="lni-whatsapp"></i></button></a>
                <a href="https://udahkadoinaja.com/kado/kotakmusikunik/"><button class="btn btn-success btn-lg w-30" type="submit">Lebih detail</button></a>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Acrylic%20Music%20Box"><button class="btn btn-danger btn-lg w-50" type="submit">Pesan Sekarang</button></a>
            </center>
          </ul> 
      </div> 
    </div>
