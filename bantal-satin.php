 ...
 <!-- Header Area-->
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Bantal Satin 40x60</h6>
        </div>
        <!-- Filter Option-->
    ...
    <div class="page-content-wrapper">
      ...
      <div class="product-slides owl-carousel">
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/9.jpg" alt=""></div>
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/15.jpg" alt=""></div>
        <div class="single-product-slide"><img src="img/product/16.jpg" alt=""></div>
        <div class="single-product-slide"><img src="img/product/17.jpg" alt=""></div>
        <!-- Single Hero Slide-->
      </div>
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container d-flex justify-content-between">
            <div class="p-title-price">
              <h6 class="mb-1">Bantal Satin 40x60</h6>
              <p class="sale-price mb-0">Rp. 126.640<span>Rp. 188.000</span></p>
            </div>
          </div>
          <!-- Ratings-->
    ...
    <div class="footer-nav-area" id="footerNav">
      <div class="suha-footer-nav h-100 py-1">
          <ul>
            <center>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Bantal%20Satin%2040x60"><button class="btn btn-success btn-lg" ><i class="lni-whatsapp"></i>&nbsp;Whatsapp</button>&nbsp;&nbsp;</a>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Bantal%20Satin%2040x60"><button class="btn btn-danger btn-lg w-50">Pesan sekarang</button></a>
            </center>
          </ul> 
      </div> 
    </div>
