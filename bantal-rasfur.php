...
?>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Bantal Rasfur 40x60</h6>
        </div>
        <!-- Filter Option-->
    ...
    <div class="page-content-wrapper">
      ...
      <div class="product-slides owl-carousel">
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/13.jpg" alt=""></div>
        <!-- Single Hero Slide-->
        <div class="single-product-slide"><img src="img/product/25.jpg" alt=""></div>
        <div class="single-product-slide"><img src="img/product/26.jpg" alt=""></div>
        <div class="single-product-slide"><img src="img/product/27.jpg" alt=""></div>
        <div class="single-product-slide"><img src="img/product/28.jpg" alt=""></div>
        <!-- Single Hero Slide-->
      </div>
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container d-flex justify-content-between">
            <div class="p-title-price">
              <h6 class="mb-1">Bantal Rasfur 40x60</h6>
              <p class="sale-price mb-0">Rp. 97.800<span>Rp. 125.300</span></p>
            </div>
          </div>
          <!-- Ratings-->
        ...
        <div class="p-specification bg-white mb-3 py-3">
          <div class="container">
            ...
            <ul>
              <li>👉🏼 Ukuran 40×60</li>
              <li>👉🏼 Bahan Rasfur</li>
              <li>👉🏼 Isi Full Silikon Halus</li>
              <li>👉🏼 Berat 500gr</li>
            </ul>
            </br>
            <p>Mengapa harus pilih BANTAL FOTO produksi KAMI??</p>
            <ul>
                <li>Kami menggunakan bahan terbaik, dari mulai bahan luar sampai dalam (isi), dikerjakan oleh tim produksi yang profesional dan peralatan terbaik sehingga menghasilkan produk Hight Quality! Warna lebih Tajam!!</li>
            </ul>
          </div>
        </div>
    ...
    <div class="footer-nav-area" id="footerNav">
      <div class="suha-footer-nav h-100 py-1">
          <ul>
            <center>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Bantal%20Rasfur%2040x60"><button class="btn btn-success btn-lg" ><i class="lni-whatsapp"></i>&nbsp;Whatsapp</button>&nbsp;&nbsp;</a>
                <a href="https://api.whatsapp.com/send?phone=628987088921&text=Hai%20kk%2C%20saya%20mau%20tanyak%20seputar%20Bantal%20Rasfur%2040x60"><button class="btn btn-danger btn-lg w-50">Pesan sekarang</button></a>
            </center>
          </ul> 
      </div> 
    </div>
